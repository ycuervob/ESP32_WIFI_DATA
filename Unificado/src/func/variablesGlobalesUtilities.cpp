...
/**
 * @brief Retorna el tiempo que el dispoisitivo usa para tomar datos.
 * @return int
 */
...
/**
 * @brief Retorna el tiempo de espera mientras se inicia el modem wifi.
 * @return int
 */

int tiempoEsperaWifi()
{
    return gVars.tiempo_espera_modem;
}

/**
 * @brief Minima aceleración para que el dispositivo deje el tiempo de reposo.
 * @return int
 */
...
/**
 * @brief Retorna el tiempo que el dispositivo tratará deconectarse a la red wifi
 * @return int
 */
